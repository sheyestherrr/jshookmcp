...
>({
  ...
  entries: [
    ...
    { tool: 'adb_package_summary', method: 'handlePackageSummary' },
    { tool: 'adb_logcat_query', method: 'handleLogcatQuery' },
    { tool: 'adb_app_cold_start_trace', method: 'handleAppColdStartTrace' },
    { tool: 'adb_file_pull', method: 'handleFilePull' },
    { tool: 'adb_file_push', method: 'handleFilePush' },
